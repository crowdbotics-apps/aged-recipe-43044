"""
Django settings for aged_recipe_43044 project.
...
ROOT_URLCONF = 'aged_recipe_43044.urls'
...
WSGI_APPLICATION = 'aged_recipe_43044.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_recipe_43044 API",
    "DESCRIPTION": "API documentation for aged_recipe_43044 App",
    "VERSION": "v1",
}
